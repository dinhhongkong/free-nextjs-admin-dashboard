export default function Loading() {
  return(
    <div aria-label="Loading..." role="status" className="py-10 justify-center flex  items-center space-x-2 w-full">
      ...
      <span className=" text-2xl font-medium text-gray-500">Đang tải...</span>
    </div>
  )
}